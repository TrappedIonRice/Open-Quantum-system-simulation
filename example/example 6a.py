...
with one radial laser drive and one axial drive coupled to all ions,
and with resonant anharmonic coupling between ilt axial mode and rocking radial mode.
 (m=n=3,p=2) 
...
#%% set ion1 for drive 1, axial laser drive
delta0 = -80
...
ion1.list_para()
ion1.plot_freq()
#%%set up ion2 for laser coupling in radial direction
ion2 = copy.copy(ion1)
ion2.df_laser = 1
ion2.delta = delta0
ion2.delta_ref = 2
...
plt.show()
#%%
Hres= ah_t.H_res2(Omegax,deltaE,ion1,ion2,True,ah_oper)
print("__________________________________________________________")
