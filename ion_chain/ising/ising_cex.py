# -*- coding: utf-8 -*-
"""
Compute the complete Hamiltonian for the 3 ion open qunatum system
used to simulate excitation transition between 2 molecules
function: Htot
@author: zhumj
"""
import numpy as np
...
def Htd(ion0,atype,): 
    ...
    for m in range(N):
        subH = tensor(spin.zero_op(2),phon.zero_op(pcut,N))
        for i in range(2):
